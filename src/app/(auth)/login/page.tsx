  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-3xl p-8 border border-slate-200 shadow-xl shadow-slate-200/50">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">Sign in to access your IEEE One Minute Talk portal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 rounded-xl border border-slate-200 focus:border-[#00629B] focus:ring-2 focus:ring-[#00629B]/20 text-sm text-slate-900 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="#" className="text-xs text-[#00629B] hover:underline font-medium">
                  Forgot Password?
                </Link>
              </div>
              <div className="relative">
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 text-center">
            <p className="text-sm text-slate-600">
              ...
              <Link href="/register" className="font-bold text-[#00629B] hover:underline">
      ...
      <div className="py-4 text-center text-xs text-slate-400">
        IEEE Student Branch One Minute Talk Platform
      </div>
    </div>
  );
}
